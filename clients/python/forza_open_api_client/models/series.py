...
class Series(BaseModel):
    ...
    is_current: StrictBool = Field(alias="isCurrent")
    rewards: Optional[List[Reward]] = None
    challenges: Optional[List[Challenge]] = None
    __properties: ClassVar[List[str]] = ["id", "game", "series", "name", "season", "week", "startsAt", "endsAt", "isCurrent", "rewards", "challenges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rewards": [Reward.from_dict(_item) for _item in obj["rewards"]] if obj.get("rewards") is not None else None,
