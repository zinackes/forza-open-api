...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/v1/"
					...
					case '/': // Prefix: "/"
						...
						case 'c': // Prefix: "compare"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleCompareCarsRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "GET",
			...
			case 'e': // Prefix: "e"
				...
				case 'x': // Prefix: "xports"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleListExportsRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
			...
			case 'f': // Prefix: "forzathon-shop"

				if l := len("forzathon-shop"); len(elem) >= l && elem[0:l] == "forzathon-shop" {
					elem = elem[l:]
				} else {
					break
				}
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleGetForzathonShopRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "GET",
				...
				case '/': // Prefix: "/history"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleListForzathonShopHistoryRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
			...
			case 's': // Prefix: "s"
				...
				case 't': // Prefix: "t"
					...
					case 'a': // Prefix: "ats"
						...
						if l := len("ats"); len(elem) >= l && elem[0:l] == "ats" {
							elem = elem[l:]
						} else {
							break
						}
					...
					case 'o': // Prefix: "ories"
						...
						if l := len("ories"); len(elem) >= l && elem[0:l] == "ories" {
							elem = elem[l:]
						} else {
							break
						}
		...
		case '/': // Prefix: "/v1/"
					...
					case '/': // Prefix: "/"
						...
						case 'c': // Prefix: "compare"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = CompareCarsOperation
									r.summary = "Compare 2 à 3 voitures côte à côte."
									r.operationID = "compareCars"
									r.operationGroup = "Cars"
									r.pathPattern = "/v1/cars/compare"
									r.args = args
									r.count = 0
									return r, true
								default:
			...
			case 'e': // Prefix: "e"
				...
				case 'x': // Prefix: "xports"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = ListExportsOperation
							r.summary = "Archives téléchargeables du dataset (JSON/CSV/JSONL) par jeu."
							r.operationID = "listExports"
							r.operationGroup = "Exports"
							r.pathPattern = "/v1/exports"
							r.args = args
							r.count = 0
							return r, true
						default:
			...
			case 'f': // Prefix: "forzathon-shop"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = GetForzathonShopOperation
						r.summary = "Rotation courante du Forzathon Shop d'un jeu."
						r.operationID = "getForzathonShop"
						r.operationGroup = "ForzathonShop"
						r.pathPattern = "/v1/forzathon-shop"
						r.args = args
						r.count = 0
						return r, true
					default:
				...
				case '/': // Prefix: "/history"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = ListForzathonShopHistoryOperation
							r.summary = "Historique des rotations du Forzathon Shop."
							r.operationID = "listForzathonShopHistory"
							r.operationGroup = "ForzathonShop"
							r.pathPattern = "/v1/forzathon-shop/history"
							r.args = args
							r.count = 0
							return r, true
						default:
					...
					case 'a': // Prefix: "ats"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "Agrégats statistiques du catalogue d'un jeu."
								r.operationID = "getStats"
								r.operationGroup = "Stats"
